		...
		<div class="container">
			...
			<div id="content">
					...
					<div class="team">
						<div class="team-info">
							<a
								href="<s:url action='updateTeam'><s:param name='teamId' value='%{#request.team.teamId}'/></s:url>"><s:property
									value="%{#request.team.teamId}" /></a>


							<h3>
								<s:property value="#request.team.teamName" />
							</h3>
							<table>
								<tr>
								...
								<s:iterator value="#request.teamEmployees"
									var="employee">
									<tr>
